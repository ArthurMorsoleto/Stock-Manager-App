...
/**
 * NOTE: this code is from https://proandroiddev.com/editing-currency-textfields-in-jetpack-compose-b7074b4682ea
 */
...
private class CurrencyVisualTransformation(
    ...
    override fun filter(text: AnnotatedString): TransformedText {
         ...
         */
        val formattedText = numberFormatter.format(originalText.toDouble())
        /**
